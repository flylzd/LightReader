...
import com.lemon.lightreader.AppConstant;
...
public class UriHelper {
    ...
    public String getImagesListUrl(String category, int pageNum) {
        ...
        sb.append(AppConstant.Urls.BAIDU_IMAGES_URLS);
        sb.append("?col=");
        try {
    ...
    public String getVideosListUrl(String category, int pageNum) {
        StringBuffer sb = new StringBuffer();
        sb.append(AppConstant.Urls.YOUKU_VIDEOS_URLS);
        sb.append("?keyword=");
        try {
            sb.append(URLEncoder.encode(category, "UTF-8"));
        } catch (UnsupportedEncodingException e) {
    ...
    public String getVideoUserUrl(int userId) {
        StringBuffer sb = new StringBuffer();
        sb.append(AppConstant.Urls.YOUKU_USER_URLS);
        sb.append("?user_id=");
        sb.append(userId);
    ...
    public String getDoubanPlayListUrl(String channelId) {
        StringBuffer sb = new StringBuffer();
        sb.append(AppConstant.Urls.DOUBAN_PLAY_LIST_URLS);
        sb.append("?channel=");
        sb.append(channelId);
